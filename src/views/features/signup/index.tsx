        ...
        <section id="signup-page" className="signup-page">
            <div className="signup-window">
                ...
                <div>
                    ...
                    <p>Don you have an account? <Link to="/login">Sign in</Link></p>
                </div>
                ...
                <div className="signup-form">
                    ...
                    <div className="signup-errors">
                        {viewmodel.createUserError?.isAliasEmpty && 
                            <span className="login-error-message">Alias is empty</span>
                        }
                        {viewmodel.createUserError?.isAliasAlreadyInUse && 
                            <span className="login-error-message">Alias already in use</span>
                        }
                        ...
                        {viewmodel.createUserError?.isEmailAlreadyInUse && 
                            <span className="login-error-message">Email already in use</span>
                        }
                        ...
                        {viewmodel.createUserError?.isCheckPasswordEmpty && 
                            <span className="login-error-message">Repeat password is empty</span>
                        }
                        {viewmodel.createUserError?.doPasswordsMismatch && 
                            <span className="login-error-message">Passwords do not match</span>
                        }                     
                    </div>
                </div>
                { !viewmodel.isLoading && 
                     ...
                     disabled={!viewmodel.canSignup()}>Submit</button>                 
                }
                { viewmodel.isLoading && 
                    <div>Is loading</div>
                }
